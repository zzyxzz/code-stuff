...
for loop in range(loops):
    ...
    bb = np.array([44.5, 63.5, 88.5, 105.0, 126.5, 146.0, 162.0, 271.0, 293.0, 312.5, 323.5, 352.0])
    if loop == loops-1:
        timings.append(np.array([44.5, 63.5, 88.5, 105.0, 126.5, 146.0, 162.0, 271.0, 293.0, 312.5, 323.5, 352.0]))
    if len(aa)==len(bb):
